...
class DeepQNetwork(object):
    def __init__(self, lr, n_actions, name, fc1_dims=1024,
                 input_dims=(80,80,4), chkpt_dir='tmp/dqn'):
        self.lr = lr
    ...
    def save_checkpoint(self):
        ...
        self.saver.save(self.sess, "./deepqnet.ckpt")

class Agent(object):
    def __init__(self, alpha, gamma, mem_size, n_actions, epsilon, batch_size,
                 replace_target=10000, input_dims=(80,80,4),
    ...
    def choose_action(self, state):
        ...
        if rand < self.epsilon:
            ...
            actions = self.q_eval.sess.run(self.q_eval.Q_values,
                    feed_dict={self.q_eval.input: np.expand_dims(state,axis=0)} )
